    ...
    <div className="report-card">
        ...
        {report.status === 'pending' && (
            ...
            <div className="resolve-form">
                <select value={resolveData.action} onChange={onActionChange} className="action-select" disabled={isResolving}>
                ...
                <textarea value={resolveData.notes} onChange={onNotesChange} placeholder="Notas adicionales..." className="notes-textarea" rows="2" disabled={isResolving}/>
                
                <button onClick={onResolve} className="btn-resolve" disabled={isResolving || !resolveData.action}>
